...
if mydisplay.smallerWindow
    [mydisplay.win, mydisplay.winrect] = PsychImaging('OpenWindow', mydisplay.screen, mydisplay.bg, mydisplay.rect);
else
    %Open a display on the Propixx
    [mydisplay.win, mydisplay.winrect] = PsychImaging('OpenWindow', mydisplay.screen, mydisplay.bg);
end
